    ...
    <>
      <figure className=" hover:scale-105 max-sm:w-full ">
        <img
          src={book.Cover}
          alt={book.Title}
          className="object-fill h-52 w-52
          hover:shadow-md hover:drop-shadow-lg
          hover:shadow-blue-950 rounded-t-md 
          2xl:w-64
        ...
        <figcaption className="relative bg-white w-52 h-32 pl-1 2xl:w-64 pt-2 rounded-b-md overflow-clip ">
          <p className=" cursor-default">
            ...
            <span className=" w-56  line-clamp-1">Titulo: {book.Title}</span>
